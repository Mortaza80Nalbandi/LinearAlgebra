...
class LinearLayer(Layer):
    ...
    def __init__(self, n_in, n_out):
        ...
        self.W = tf.Variable(tf.random.normal([n_in, n_out], 0, 1, tf.float32, seed=1), shape=(n_in, n_out),
                             dtype=float)
...
def grad_dec(data, Layers):
    ...
    for iteration in range(max_nb_of_iterations):
        ...
        error_no__class1, error_no__class2, error_no__class3 = data[0].shape[0] / 3, data[0].shape[0] / 3, \
                                                               data[0].shape[0] / 3
        ...
        for i in range(data[0].shape[0]):
            ...
            if data[1][i][2] == 1 and output[2] == 1:
                error_no__class3 -= 1
        print("iteration ",iteration," errors: class 1 :" ,error_no__class1," errors: class 2 :" ,error_no__class2,
        " errors: class 3 :" ,error_no__class3)
